    ...
    <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a href="instructor.php?id=<?php echo $courseRow['id']; ?>"
                    class="btn btn-md waves-effect waves-light">View Instructor Details</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a href="viewContent.php?id=<?php echo $courseRow['id']; ?>"
                    class="btn btn-md waves-effect waves-light">View Course Content</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a href="viewAnnouncment.php?id=<?php echo $courseRow['id']; ?>"
                    class="btn btn-md waves-effect waves-light">View Announcements</a>
            </div>
        </div>
    </li>
</ul>