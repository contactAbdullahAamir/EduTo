...
<section class="py-2 text-light" style="background-color: #3F51B5; text-align: center; margin-top: 230px;">
        ...
        <!-- <span> @copyright Eduto Leaning Managent System <script> document.write(new Date().getFullYear()); </script>  -->
