        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="alert alert-primary" role="alert"
                    style="background-color: #9BC3E5; color: #3F51B5; font-weight: bold; margin-left: 50px;  margin-right: 50px; margin-top:30px">
                    Dear Student, Your registration number is <b>
                        <?php echo $registrationNumber; ?>
                    </b>. If your registration number is incorrect or the format is not correct, contact immediately to
                    your
                    instructor. Otherwise, you will not be able to view your result.
                </div>
                            ...
                            <div class="col-lg-4 my-5">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-5 mt-4">
                                        ...
                                        <p><i class="fa fa-star text-warning"></i> <i
